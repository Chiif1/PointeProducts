...
public class XGuestUserPayment extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_x_guest_user_payment);
    ...
    private void startCheckout() {
       ...
       /* String json = "{"
        ...
        Button payButton = findViewById(R.id.XpayButtonGuest);
        payButton.setOnClickListener((View view) -> {

            //JSON setup for Stripe
            try {
                EditText receipt_email = findViewById(R.id.XemailTxBoxGuest);
                ...
                EditText name = findViewById(R.id.XnameRecipientGuesShippingTxBox);
                EditText shippingAddress = findViewById(R.id.XaddressTxGuestShipping1);
                EditText shippingAddress2 = findViewById(R.id.XaddressTxBoxGuestShipping2);
                EditText shippingCity = findViewById(R.id.XcityTxBoxGuestShipping);
                EditText shippingState = findViewById(R.id.XstateTxBoxGuestShipping);
                EditText shippingzipcode = findViewById(R.id.XzipcodeTxBoxGuestShipping);
    ...
    public void cardSend() {
        ...
        CardInputWidget cardInputWidget = findViewById(R.id.XcardInputWidgetGuest);
        ...
        if (restartDemo) {
            builder.setPositiveButton("Return Home",
                    (DialogInterface dialog, int index) -> {
                        ...
                        Intent intent = new Intent(XGuestUserPayment.this, XHomePage.class);
    ...
    private final class PayCallback implements Callback { //was static
        @NonNull
        private final WeakReference<XGuestUserPayment> activityRef;

        PayCallback(@NonNull XGuestUserPayment activity) {
            activityRef = new WeakReference<>(activity);
        }

        @Override
        public void onFailure(@NonNull Call call, @NonNull IOException e) {
            final XGuestUserPayment activity = activityRef.get();
            if (activity == null) {
                return;
            }
    ...
    private static final class PaymentResultCallback
        ...
        PaymentResultCallback(@NonNull XGuestUserPayment activity) {
            activityRef = new WeakReference<>(activity);
        }
